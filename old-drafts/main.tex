...
\lstset{language=r,label=head concreteArgs silent,caption= ,captionpos=b,numbers=none,otherkeywords={}, deletekeywords={}}
\begin{lstlisting}
...
\label{sec:org3ac78bd}
\subsection{Competing Risks pbc Analysis}
\label{sec:orgc266cc6}
